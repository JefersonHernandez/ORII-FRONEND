...
export class AdminComponent implements OnInit,AfterViewInit {
 ...
 classIs: boolean | undefined;
  ...
  constructor(private backSvc:BackgroundService, private modalidadSvc:ModalidadService, private router:Router, private expSvc:ExporterService){
  ...
  ngOnInit(): void {
   ...
   this.modalidadSvc.getRecentMovilidad().subscribe((data) => {
